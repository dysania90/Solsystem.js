...
window.onload = function init() {
    ...
    var moonData = generateSphere(16, 16);
    var moon = new SceneNode(sphereNode2);
    moon.translate([4,0,0]);
    moon.scale([0.5,0.5,0.5]);

    var moonSatelliteData = generateSphere(16, 16);
    var moonSatellite = new SceneNode(moon);
    moonSatellite.translate([3,0,0]);
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(flatten(moonData.points)), gl.STATIC_DRAW);
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(flatten(moonSatelliteData.points)), gl.STATIC_DRAW);
    ...
    function step(timestamp) {
        ...
        sphereNode1.rotateSelf((10000000/(3600*24*25)*diffSeconds), [0,1,0]);
        sphereNode2.rotateSelf((10000000/(3600*24)*diffSeconds), [0,1,0]);
        sphereNode2.rotate((10000000/(3600*24*365)*diffSeconds), [0,1,0]);
        moon.rotateSelf((10000000/(3600*24*27)*diffSeconds), [0,1,0]);
        moon.rotate((10000000/(3600*24*27)*diffSeconds), [0,1,0]);
        moonSatellite.rotate((10000000/(3600*24*27)*diffSeconds), [0,1,0]);
